...
public class ServiceRegister implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        ServiceInstance<Object> instance = ServiceInstance.builder().name("mall").address("192.168.171.1").port(8080).build();
        ...
        System.out.println("mall-one register successful");
    }
}
